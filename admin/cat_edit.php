<?php
    ...
    if( isset($_POST['c_update'])){
        ...
        $update_sql = "UPDATE category SET name='$cname', icon='$cicon' WHERE id=$uid";
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card p-3 mb-4">
                     ...
                     <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
                        <input value="<?php echo $final['id'];?>" name="u_id" type="hidden">
                         <div class="mb-3">
                         ...
                         <div class="mb-3">
                          <button class="btn btn-success" type="submit" name="c_update">Update</button>
